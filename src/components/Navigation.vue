...
<template>
	<nav aria-label="Site Nav" class=" h-70px max-w-8xl flex items-center justify-between p-4">
		...
		<ul class="flex items-center gap-2 text-sm ">
			...
			<li v-for="r of routes" :key="r.path" class="hidden !block ml-auto">
			...
			<li>
				<a class="inline-flex items-center gap-2 rounded-lg px-3 py-2"
					href="https://github.com/dishait/tov-template" target="_blank">
